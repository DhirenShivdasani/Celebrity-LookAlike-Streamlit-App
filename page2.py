...
def camera_input():
	...
	if file_image is not None:
		...
		if predict:
			...
			st.image([cv2.resize(input_image, (150,200)), cv2.resize(load_mtcnn(mtcnn_img), (150,200)), cv2.resize(embed_img, (150,200), interpolation = cv2.INTER_AREA), cv2.resize(celeb_look_alike_img, (150,200))], clamp = True)
